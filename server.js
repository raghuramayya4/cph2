...
app.get("/" , (req , res) => {
    res.sendFile(path.join(__dirname, 'public', 'mainlandingpage.html'));
});
...
app.post("/ideaSubmission" , async(req , res) => {
    const {idea_name , idea_email , idea_category , idea_domain , idea_desc} = req.body;
    await db.collection('Student_Ideas').add({idea_name , idea_email , idea_category , idea_domain , idea_desc});
